...
export const metadata = publicPageMetadata({
  ...
  description: "Khám phá các gói du lịch Việt Nam, tour nghỉ dưỡng và lịch trình thiết kế riêng từ TimesGreen. Đa dạng điểm đến từ Bắc chí Nam với chi phí tốt nhất.",
  path: "/goi-du-lich",
});
