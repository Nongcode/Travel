...
export default function HomepageBannersPage() {
  ...
  // Filter homepage banners
  const homepageBanners = banners.filter((b) => b.type === "homepage");
  const filteredBanners = homepageBanners.filter((b) =>
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 mt-1">
          Thiết lập các hình ảnh quảng cáo lớn (Hero Banner) xuất hiện ngay đầu trang chủ VietVista. Kích thước khuyến nghị: 1920x800px.
        </p>
      </div>
        ...
        <div className="lg:col-span-4">
          <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm sticky top-24">
            <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest mb-4">
              {editingBanner ? "Cập nhật Banner" : "Thêm Banner Trang chủ"}
            </h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="Ví dụ: Discover Untouched Vietnam..."
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="Ví dụ: Handcrafted private itineraries..."
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600 transition-all font-semibold text-slate-700"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="Ví dụ: /hero-bg.jpg hoặc link online..."
        ...
        <div className="lg:col-span-8 space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm flex flex-col sm:flex-row gap-4 items-center justify-between">
            <h4 className="text-sm font-black text-slate-800 uppercase tracking-widest">
              Danh sách Banner ({homepageBanners.length})
            </h4>
                ...
                <tbody className="divide-y divide-slate-50 text-slate-700 text-sm">
                  {filteredBanners.length === 0 ? (
                    <tr>
                      ...
                      >
                        Không tìm thấy banner trang chủ nào.
                      </td>
                    </tr>
                  ) : (
